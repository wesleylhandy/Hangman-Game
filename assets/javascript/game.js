...
/*
	...
	Use CANVAS to draw hangman
	Track wins and losses on screen
...
var hangmanGame = {
	...
	words : [
		{
			...
			used: false,
			site: '<iframe class="video" width="100%" src="https://www.youtube.com/embed/ZNiRzZ66YN0?list=PL4870492ACBDC2E7C" frameborder="0" allowfullscreen></iframe>'
		},
		{
			word: "googol",
			type: "txt",
			...
			used: false,
			site: '<iframe class="video" width="100%" src="https://www.youtube.com/embed/5JOAoiX1LHA" frameborder="0" allowfullscreen></iframe>'
		},
		{	
			word: "2.71828183",
			type: "num",
			...
			used: false,
			site: '<iframe class="video" width="100%" src="https://www.youtube.com/embed/seUU2bZtfgM?list=PLt5AfwLFPxWJm_xYEUbnOi0foDNp2dwEX" frameborder="0" allowfullscreen></iframe>'
		},
		{
			word: "1.61803398",
			type: "num",
			...
			used: false,
			site: '<iframe class="video" width="100%" src="https://www.youtube.com/embed/D8ntDpBm6Ok?list=PLt5AfwLFPxWIDalIezb351yUymQhXaRv-" frameborder="0" allowfullscreen></iframe>'
		},
		{
			word: "zero",
			type: "txt",
			...
			used: false,
			site: '<iframe class="video" width="100%" src="https://www.youtube.com/embed/8t1TC-5OLdM?list=PLt5AfwLFPxWLNZRKWlcRmTABh_SExiiCj" frameborder="0" allowfullscreen></iframe>'
		},
		{
			word: "infinity",
			type: "txt",
			...
			used: false,
			site: '<iframe class="video" width="100%" src="https://www.youtube.com/embed/dDl7g_2x74Q" frameborder="0" allowfullscreen></iframe>'
		},
		{
			word: "binary",
			type: "txt",
			...
			used: false,
			site: '<iframe class="video" width="100%" src="https://www.youtube.com/embed/umYvFdU54Po" frameborder="0" allowfullscreen></iframe>'
		},
		{
			...
			used: false,
			site: '<iframe class="video" width="100%" src="https://www.youtube.com/embed/qiNcEguuFSA?list=PLt5AfwLFPxWLD3KG-XZQFTDFhnZ3GHMlW" frameborder="0" allowfullscreen></iframe>'
		},
		{
			word: "calculus",
			type: "txt",
			...
			used: false,
			site: '<iframe class="video" width="100%" src="https://www.youtube.com/embed/shEk8sz1oOw" frameborder="0" allowfullscreen></iframe>'
		},
		{
			word: "geometry",
			type: "txt",
			...
			used: false,
			site: '<iframe class="video" width="100%" src="https://www.youtube.com/embed/6Lm9EHhbJAY" frameborder="0" allowfullscreen></iframe>'
		},
		{
			...
			used: false,
			site: '<iframe class="video" width="100%" src="https://www.youtube.com/embed/ItiFO5y36kw" frameborder="0" allowfullscreen></iframe>'
		},
		{
			word: "dimensions",
			type: "txt",
			...
			used: false,
			site: '<iframe class="video" width="100%" src="https://www.youtube.com/embed/2s4TqVAbfz4" frameborder="0" allowfullscreen></iframe>'
		},
		{
			word: "polygon",
			type: "txt",
			...
			used: false,
			site: '<iframe class="video" width="100%" src="https://www.youtube.com/embed/87uo2TPrsl8" frameborder="0" allowfullscreen></iframe>'
		},
		{
			...
			used: false,
			site: '<iframe class="video" width="100%" src="https://www.youtube.com/embed/NGMRB4O922I" frameborder="0" allowfullscreen></iframe>'
		},
		{
			word: "square root",
			type: "txt",
			...
			used: false,
			site: '<iframe class="video" width="100%" src="https://www.youtube.com/embed/5sKah3pJnHI" frameborder="0" allowfullscreen></iframe>'
		},
		{
			...
			used: false,
			site: '<iframe class="video" width="100%" src="https://www.youtube.com/embed/uCsD3ZGzMgE" frameborder="0" allowfullscreen></iframe>'
		},
		{
			word: "prime numbers",
			type: "txt",
			...
			used: false,
			site: '<iframe class="video" width="100%" src="https://www.youtube.com/embed/2JM2oImb9Qg?list=PL0D0BD149128BB06F" frameborder="0" allowfullscreen></iframe>'
		},
		{
			...
			clue: "{1 + 2 + 3 + 4 + ....} = -1/12.",
			used: false,
			site: '<iframe class="video" width="100%" src="https://www.youtube.com/embed/w-I6XTVZXww" frameborder="0" allowfullscreen></iframe>'
		},
		{
			word: "topology",
			type: "txt",
			...
			used: false,
			site: '<iframe class="video" width="100%" src="https://www.youtube.com/embed/W18FDEA1jRQ?list=PLt5AfwLFPxWJeBhzCJ_JXdaIXi_YJl7Bh" frameborder="0" allowfullscreen></iframe>'
		}
	],
	sounds: {
		dupe: {
	...
	randomizeWords: function() {
		...
		this.randomWords = this.words.slice(0);
		for ( let i = this.words.length -1; i > 0; i--) {
			//get a random question
			var randomIndex = Math.floor(Math.random() * (i + 1));
			var word = this.randomWords[randomIndex];
			//push to selected
			this.randomWords[randomIndex] = this.randomWords[i];
			//remove from copied questions
			this.randomWords[i] = word;
		}
	},
	//function to find random word not yet played
	getNextTerm: function() {
		if (this.usedTerms == this.randomWords.length) {
			this.randomizeWords();
			this.usedWords = 0;
		}
		this.currentTerm = this.randomWords[this.usedTerms];
		this.usedTerms++;
...
var startGame = function() {
	...
	hangmanGame.randomizeWords();
	hangmanGame.getNextTerm();
